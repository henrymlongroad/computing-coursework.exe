...
\begin{figure}[ht!]
\centering
\includegraphics[trim = 5mm 30mm 5mm 10mm, clip,width=110mm]{questionaire.JPG}
...
\begin{algorithmic}[1]
\set{$lowest\ minimum\ amount = 135$}
\if{$item = lowest\ minimum\ amount$}\send{$"you\ don't\ need\ any\ more\ tablets"$}\else\send{$"you\ need\ more\ tablets"$}\Endif
\end{algorithmic}
\end{algorithm}
